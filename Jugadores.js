// Lista de jugadores (ATK/DEF/TACT/STA actualizados desde la tabla adjunta)
const jugadores = [
  { nombre: "Ale", ataque: 2.60, defensa: 2.53, tactica: 1.20, estamina: 2.00, puntualidad: 3 },
  { nombre: "Fer", ataque: 3.32, defensa: 2.93, tactica: 3.00, estamina: 1.80, puntualidad: 3 },
  { nombre: "Jacob", ataque: 4.11, defensa: 3.67, tactica: 3.50, estamina: 3.40, puntualidad: 3 },
  { nombre: "Min", ataque: 1.89, defensa: 1.94, tactica: 1.50, estamina: 1.00, puntualidad: 3 },
  { nombre: "Damian", ataque: 4.63, defensa: 4.05, tactica: 4.30, estamina: 3.80, puntualidad: 3 },
  { nombre: "Mario", ataque: 1.78, defensa: 2.36, tactica: 1.00, estamina: 1.00, puntualidad: 3 },
  { nombre: "Mirko", ataque: 3.72, defensa: 4.10, tactica: 3.50, estamina: 3.50, puntualidad: 3 },
  { nombre: "Queco (GK)", ataque: 1.55, defensa: 4.39, tactica: 4.00, estamina: 4.00, puntualidad: 3 },
  { nombre: "Oriol (GK)", ataque: 1.34, defensa: 4.23, tactica: 4.00, estamina: 4.00, puntualidad: 3 },
  { nombre: "Abel", ataque: 3.05, defensa: 2.95, tactica: 3.00, estamina: 2.00, puntualidad: 3 },
  { nombre: "Arnau", ataque: 4.36, defensa: 3.81, tactica: 3.50, estamina: 3.20, puntualidad: 3 },
  { nombre: "Niccolo", ataque: 3.43, defensa: 3.63, tactica: 3.00, estamina: 3.00, puntualidad: 3 },
  { nombre: "Merino", ataque: 2.90, defensa: 3.63, tactica: 2.80, estamina: 3.00, puntualidad: 3 },
  { nombre: "Liya", ataque: 3.58, defensa: 3.34, tactica: 2.80, estamina: 3.00, puntualidad: 3 },
  { nombre: "Yuancai", ataque: 1.59, defensa: 1.33, tactica: 1.20, estamina: 1.20, puntualidad: 3 },
  { nombre: "Jon", ataque: 2.72, defensa: 2.47, tactica: 2.00, estamina: 2.50, puntualidad: 3 },
  { nombre: "Peña", ataque: 2.79, defensa: 2.69, tactica: 2.00, estamina: 4.00, puntualidad: 3 },
  { nombre: "Manu", ataque: 4.46, defensa: 4.18, tactica: 4.00, estamina: 4.30, puntualidad: 3 },
  { nombre: "Vito", ataque: 3.64, defensa: 4.42, tactica: 4.00, estamina: 3.70, puntualidad: 3 },
  { nombre: "Alex Jimenez", ataque: 4.62, defensa: 4.51, tactica: 4.00, estamina: 4.00, puntualidad: 3 },
  { nombre: "Andrea Maioli", ataque: 4.60, defensa: 4.58, tactica: 4.50, estamina: 4.50, puntualidad: 3 },
  { nombre: "Outman", ataque: 4.46, defensa: 4.90, tactica: 4.50, estamina: 4.50, puntualidad: 3 },
  { nombre: "Harris", ataque: 2.38, defensa: 2.08, tactica: 2.00, estamina: 2.00, puntualidad: 2 },
  { nombre: "Sergio Ramos", ataque: 4.07, defensa: 3.60, tactica: 4.00, estamina: 3.60, puntualidad: 3 },
  { nombre: "Tolga", ataque: 3.42, defensa: 2.67, tactica: 3.00, estamina: 3.20, puntualidad: 3 },
  { nombre: "Amadou", ataque: 3.47, defensa: 3.30, tactica: 3.00, estamina: 3.20, puntualidad: 3 },
  { nombre: "Steven", ataque: 3.04, defensa: 3.08, tactica: 2.50, estamina: 2.50, puntualidad: 3 },
  { nombre: "Ricard", ataque: 2.26, defensa: 2.38, tactica: 1.80, estamina: 2.00, puntualidad: 3 },
  { nombre: "David Rovira", ataque: 2.98, defensa: 2.96, tactica: 2.00, estamina: 2.00, puntualidad: 3 },
  { nombre: "Gustavo Madrigal", ataque: 2.91, defensa: 2.88, tactica: 2.00, estamina: 3.20, puntualidad: 3 },
  { nombre: "Diego", ataque: 1.98, defensa: 2.35, tactica: 2.00, estamina: 1.50, puntualidad: 3 },
  { nombre: "Andrea Aroldi", ataque: 2.17, defensa: 2.01, tactica: 1.60, estamina: 1.60, puntualidad: 3 },
  { nombre: "Vitor", ataque: 2.77, defensa: 2.72, tactica: 2.50, estamina: 2.50, puntualidad: 3 },
  { nombre: "Mario Lecce", ataque: 3.28, defensa: 3.35, tactica: 3.00, estamina: 3.00, puntualidad: 3 },
  { nombre: "Jeff", ataque: 3.83, defensa: 3.20, tactica: 3.50, estamina: 4.00, puntualidad: 3 },
  { nombre: "Payno", ataque: 3.04, defensa: 2.74, tactica: 2.00, estamina: 2.00, puntualidad: 3 },
  { nombre: "Kevin", ataque: 4.61, defensa: 4.23, tactica: 4.00, estamina: 4.00, puntualidad: 3 },
  { nombre: "Fabien", ataque: 2.98, defensa: 2.85, tactica: 2.00, estamina: 2.80, puntualidad: 3 },
  { nombre: "Romain", ataque: 4.50, defensa: 4.48, tactica: 4.60, estamina: 4.30, puntualidad: 3 },
  { nombre: "Maykel", ataque: 3.01, defensa: 2.84, tactica: 2.00, estamina: 3.00, puntualidad: 3 },
  { nombre: "Alex Lopez", ataque: 3.58, defensa: 3.17, tactica: 3.00, estamina: 2.00, puntualidad: 3 },
  { nombre: "Buda", ataque: 3.59, defensa: 3.82, tactica: 3.00, estamina: 3.70, puntualidad: 3 },
  { nombre: "Massi", ataque: 4.70, defensa: 3.85, tactica: 4.70, estamina: 4.00, puntualidad: 3 },
  { nombre: "Trompia", ataque: 4.60, defensa: 4.53, tactica: 4.70, estamina: 4.00, puntualidad: 3 },
  { nombre: "Treppo", ataque: 3.90, defensa: 3.88, tactica: 3.50, estamina: 3.60, puntualidad: 3 },
  { nombre: "Lori", ataque: 3.55, defensa: 2.95, tactica: 3.60, estamina: 3.40, puntualidad: 3 },
  { nombre: "Tobi (GK)", ataque: 2.26, defensa: 4.05, tactica: 4.30, estamina: 4.30, puntualidad: 3 },
  { nombre: "Dominic", ataque: 3.30, defensa: 3.00, tactica: 3.00, estamina: 3.00, puntualidad: 3 },
  { nombre: "Rolando", ataque: 1.50, defensa: 3.00, tactica: 2.80, estamina: 2.80, puntualidad: 3 },
  { nombre: "Tomas", ataque: 2.85, defensa: 2.75, tactica: 3.00, estamina: 3.00, puntualidad: 3 },
  ...
  { nombre: "Elias", ataque: 1.33, defensa: 1.50, tactica: 1.50, estamina: 1.50, puntualidad: 3 },
  { nombre: "Marcelo (GK)", ataque: 0.75, defensa: 4.00, tactica: 3.50, estamina: 3.00, puntualidad: 3 },
  { nombre: "Jorge", ataque: 3.00, defensa: 3.00, tactica: 3.00, estamina: 3.00, puntualidad: 3 },
  { nombre: "Enric Ll.", ataque: 1.50, defensa: 1.50, tactica: 1.50, estamina: 1.50, puntualidad: 3 },
  { nombre: "Codony", ataque: 4.00, defensa: 4.00, tactica: 4.00, estamina: 4.00, puntualidad: 3 },
  { nombre: "Magnus", ataque: 3.00, defensa: 3.00, tactica: 3.00, estamina: 3.00, puntualidad: 3 },
  { nombre: "Jeremy", ataque: 2.50, defensa: 2.50, tactica: 2.50, estamina: 2.50, puntualidad: 3 }
];
